...
{
    { "nativeGetPagerStats", "(Lcom/mobilife/sqlitere/database/sqlite/SQLiteDebug$PagerStats;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "com/mobilife/sqlitere/database/sqlite/SQLiteDebug$PagerStats");
    ...
    return jniRegisterNativeMethods(env, "com/mobilife/sqlitere/database/sqlite/SQLiteDebug",
