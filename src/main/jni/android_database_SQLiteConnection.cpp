...
/*
** Modified to support Regular Expressions and sqlite Encryption by Behzad Ghaffarnejad
*/
...
int sqlite3_regexp_init(sqlite3 *db, char **err)
{
...
static jlong nativeOpen(JNIEnv* env, jclass clazz, jstring pathStr, jint openFlags,
	...
	//register extentions
	//sqlite3_log(SQLITE_WARNING, "the log");
	char *err1; /* ignored */
...
static JNINativeMethod sMethods[] =
{
    ...
    { "nativeClose", "(J)V",
            (void*)nativeClose },
    { "nativeRegisterCustomFunction", "(JLcom/mobilife/sqlitere/database/sqlite/SQLiteCustomFunction;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "com/mobilife/sqlitere/database/sqlite/SQLiteCustomFunction");
    ...
    return jniRegisterNativeMethods(env, 
        "com/mobilife/sqlitere/database/sqlite/SQLiteConnection",
